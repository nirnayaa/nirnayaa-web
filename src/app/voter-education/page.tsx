      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="bg-white border border-gray-200 rounded-lg p-8 mb-8">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-semibold text-gray-900">Your Voting Rights</h2>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h4 className="font-medium text-gray-900 mb-2">Positions & Promises</h4>
                  <ul className="text-sm text-gray-600 space-y-1">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h4 className="font-medium text-gray-900 mb-2">Character & Integrity</h4>
                  <ul className="text-sm text-gray-600 space-y-1">
        ...
        <section className="bg-white border border-gray-200 rounded-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="text-center p-4">
              ...
              <h3 className="font-medium text-gray-900 mb-2">Engage Locally</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="text-center p-4">
              ...
              <h3 className="font-medium text-gray-900 mb-2">Hold Officials Accountable</h3>
              <p className="text-sm text-gray-600">
